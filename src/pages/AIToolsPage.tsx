  ...
  return (
    <div className="flex flex-col h-full bg-background animate-in fade-in duration-700 relative">
      ...
      <div className="flex-1 overflow-y-auto scroll-smooth group/scroll pb-32">
        <div className="max-w-3xl mx-auto px-4 pt-4 sm:pt-8 space-y-6 sm:space-y-8">
          {messages.length === 0 ? (
      ...
      <div className="absolute bottom-0 left-0 right-0 pointer-events-none z-20">
        <div className="max-w-3xl mx-auto px-4 pb-4 sm:pb-8 pt-10 bg-linear-to-t from-background via-background/90 to-transparent">
